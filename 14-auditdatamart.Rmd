...
Below is an example of what may be contained in an ETL notebook.
...
if (days_since_last_term > 14) {stop("Danger!")}
```
...
if (nrow(new_count) != nrow(cleaned_staff)) {stop("Danger!")}
```
