...
\includegraphics[width=1\linewidth]{Audit_Analytics_with-R_files/figure-latex/unnamed-chunk-1-1}
...
\includegraphics[width=1\linewidth]{Audit_Analytics_with-R_files/figure-latex/unnamed-chunk-2-1}
...
\includegraphics{Audit_Analytics_with-R_files/figure-latex/unnamed-chunk-41-1.pdf}
...
\includegraphics[width=0.5\linewidth]{Audit_Analytics_with-R_files/figure-latex/unnamed-chunk-97-1} \includegraphics[width=0.5\linewidth]{Audit_Analytics_with-R_files/figure-latex/unnamed-chunk-97-2} \includegraphics[width=0.5\linewidth]{Audit_Analytics_with-R_files/figure-latex/unnamed-chunk-97-3} \includegraphics[width=0.5\linewidth]{Audit_Analytics_with-R_files/figure-latex/unnamed-chunk-97-4}
...
\includegraphics{Audit_Analytics_with-R_files/figure-latex/unnamed-chunk-101-1.pdf}
...
\StringTok{  }\KeywordTok{filter}\NormalTok{(account }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{'exp_materials_6000'}\NormalTok{, }\StringTok{'exp_consulting_6500'}\NormalTok{, }\StringTok{'exp_meals_7000'}\NormalTok{)) }\OperatorTok{%>%}
...
\includegraphics{Audit_Analytics_with-R_files/figure-latex/unnamed-chunk-106-1.pdf}
...
\includegraphics{Audit_Analytics_with-R_files/figure-latex/unnamed-chunk-107-1.pdf}
...
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{day_of_week =} \KeywordTok{wday}\NormalTok{(gl_date, }\DataTypeTok{label =} \OtherTok{TRUE}\NormalTok{),  }\CommentTok{# Label is useful if you tend to forget what each number means}
         \DataTypeTok{t_weekend =}\NormalTok{ day_of_week }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{'Sat'}\NormalTok{, }\StringTok{'Sun'}\NormalTok{))}
...
\includegraphics{Audit_Analytics_with-R_files/figure-latex/unnamed-chunk-129-1.pdf}
...
\includegraphics{Audit_Analytics_with-R_files/figure-latex/unnamed-chunk-134-1.pdf}
...
\includegraphics{Audit_Analytics_with-R_files/figure-latex/unnamed-chunk-135-1.pdf}
...
\includegraphics[width=1\linewidth]{Audit_Analytics_with-R_files/figure-latex/unnamed-chunk-184-1}
...
\includegraphics[width=1\linewidth]{Audit_Analytics_with-R_files/figure-latex/unnamed-chunk-185-1}
...
\includegraphics[width=1\linewidth]{Audit_Analytics_with-R_files/figure-latex/unnamed-chunk-189-1}
