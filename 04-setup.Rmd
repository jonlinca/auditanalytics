...
As these packages are in active development, they are not currently available on CRAN. You are able to install this package directly from GitHub - first, install [RTools](https://cran.r-project.org/bin/windows/Rtools/) on your computer, which allows you to build and compile your own packages. Then, run the following command.
